...
class ProjectMakerCommand(sublime_plugin.WindowCommand):
    def run(self):
        ...
        for root, dirs, files in os.walk(sublime.packages_path()):
            for d in dirs:
                if d.upper() == "ProjectTemplates".upper():
                    self.templates_path = os.path.join(root, "ProjectTemplates")
                    break
    ...
    def get_project_name(self):
        ...
        self.window.show_input_panel("Target", self.project_name, self.on_project_name, None, None)
